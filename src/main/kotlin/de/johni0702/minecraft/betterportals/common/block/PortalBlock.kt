...
import de.johni0702.minecraft.betterportals.common.get
import de.johni0702.minecraft.betterportals.common.minus
import de.johni0702.minecraft.betterportals.common.opposite
import de.johni0702.minecraft.betterportals.common.plus
import de.johni0702.minecraft.betterportals.common.rotate
import de.johni0702.minecraft.betterportals.common.times
import de.johni0702.minecraft.betterportals.common.toImmutable
...
interface PortalBlock<EntityType> where EntityType: Entity, EntityType: Linkable {
    ...
    fun findOrCreateRemotePortal(
        ...
        val remotePosition = BlockPos(
            ...
            localPos.y.coerceAtMost(maxY - (portalBlocks.maxOfOrNull { it.y } ?: 0)),
    ...
    fun placePortalFrame(world: World, axis: EnumFacing.Axis, portalBlocks: Set<BlockPos>) {
        ...
        val minY = portalBlocks.minOfOrNull { it.y } ?: 0
